...
| ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`docs/requirements.md`](docs/requirements.md)         | **The specification.** 131 functional + 32 non-functional requirements, each with Given/When/Then acceptance criteria. Read the full entry for a requirement before implementing it — including any dated amendment note beneath it                                      |
