...
const URGENCY_WINDOW_MIN_MS = 24 * HOUR_MS;
const URGENCY_WINDOW_MAX_MS = 48 * HOUR_MS;
 ...
 * @returns {boolean}
 */
function computeIsUrgent(startAt, now = Date.now()) {
...
module.exports = { computeIsUrgent, URGENCY_WINDOW_MIN_MS, URGENCY_WINDOW_MAX_MS };