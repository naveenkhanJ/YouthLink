...
| `accountStatus`                | Enum(`AccountStatus`) | default `PENDING_SIGNUP`                        | FR-ACC-06                                                                                                       |
| `signupExpiresAt`              | DateTime              | nullable                                        | 24h incomplete-signup expiry; cleared on completion (FR-ACC-06)                                                 |
...
- **FR-ACC-06 requires an abandoned signup to release its phone number** after 24 hours. A blanket unique index keeps that phone locked to a dead `PENDING_SIGNUP` row forever unless a cleanup job hard-deletes it.
...
| `purpose`        | Enum(`OtpPurpose`) | required                      | `SIGNUP`, `LOGIN`, `PASSWORD_RESET`, `PHONE_CHANGE`, `ADMIN_LOGIN`                                                                                                 |
...
| `reason`     | String(300)                   | nullable                                  | Optional, capped (FR-ENDORSE-04)                                 |
