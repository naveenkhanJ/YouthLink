/**
 * Screen manifest for the FR-ENDORSE module — TBD (Sprint 2).
 *
 ...
 *             that — e.g. "EndorsementRegister", not "Register".
 ...
 *   export default [
 *     { name: "EndorsementExample", component: ExampleScreen, options: { title: "Example" } },
 *   ];
 */
export default [];
