/**
 * Screen manifest for the FR-ENG module — TBD (Sprint 2).
 *
 ...
 *             that — e.g. "EngagementRegister", not "Register".
 ...
 *   export default [
 *     { name: "EngagementExample", component: ExampleScreen, options: { title: "Example" } },
 *   ];
 */
export default [];
